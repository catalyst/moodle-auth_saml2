...
$string['test_endpoint_desc'] = 'Enter a URL to test connection against for IdP redirection. Some users or networks may not have connectivity to the IdP bsaed on account or network permissions.';
